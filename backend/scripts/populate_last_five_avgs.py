...
csv_path = BASE_DIR / "data" / "last_five_avg.csv"

from backend.db.mongo import fighters_last_five_avgs_collection
from backend.models.fighter_career_avg import FighterCareerAvg
from backend.db.mongo import fighters_collection

def populate_last_five_avgs(csv_path):
    ...
    for _, row in df.iterrows():
        ...
        fighters_last_five_avgs_collection.update_one(
            {"fighter_id": fighter_id},
...
if __name__ == "__main__":
    populate_last_five_avgs(csv_path)
